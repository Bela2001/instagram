...
class Post extends HTMLElement {
    ...
    static get observedAttributes() {
        const attris: Record<Attributes, null> = {username: null, numerolikes: null, comentario1: null, fecha: null};
    ...
    attributeChangedCallback(prop: Attributes, oldValue: string, newValue: string) {
        switch (prop) {
        default:
            this[prop] = newValue;
            break;
